...
import { z } from 'zod'
import { OrderTableSkeleton } from './components/LoadingOrderSkeleton'
...
export function Orders() {
    ...
    const { data: result, isLoading: isLoadingsOrders } = useQuery({
                ...
                <div className='space-y-2.5'>
                    ...
                    <div className='border rounded-md'>
                        <Table>
                            ...
                            {isLoadingsOrders && <OrderTableSkeleton/>}
